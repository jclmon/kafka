 ...
 * Info del cluster
 * 
 * Lista de topics y lista de mapas de particionado
 * 
 * 
 * Serviría para hacer pooling y enviar alertas dependiendo de reglas implementadas
 * 
 * @author Admin
 *
 */
public class InfoConsumer {
    ...
    public static void main(String[] args) {
        ...
        props.put(ConsumerConfig.GROUP_ID_CONFIG, "test-simple");
